...
<CardGroup cols={2}>
  ...
  <Card title="Data Loading" icon="database" href="/router/data-loading">
    Learn advanced data loading patterns and caching
  </Card>
  
  <Card title="Search Params" icon="magnifying-glass" href="/router/search-params">
    Master type-safe URL state management
  </Card>
  
  <Card title="Authenticated Routes" icon="lock" href="/router/authenticated-routes">
